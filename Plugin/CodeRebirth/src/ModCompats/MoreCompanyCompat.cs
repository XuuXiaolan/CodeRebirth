...
internal static class MoreCompanySoftCompat
{
    ...
    public static void TryDisableOrEnableCosmetics(PlayerControllerB targetPlayer, bool disable)
    {
    ...
    internal static void DisableOrEnableCosmetics(PlayerControllerB targetPlayer, bool disable)
    {
