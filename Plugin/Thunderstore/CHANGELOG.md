...
- Updated for V80, PLEASE DO NOT USE THIS ON V73, IT WILL NOT WORK.
...
- Someone likes to play hide and seek on your ship.
...
- Added vending machines and many new items to accompany them.
  - Common
  - Rare
  - Epic
  - Legendary
...
- Marrow splitter blood collection buffed, battery usage increased.
- Emissive textures fixed on various plushies.
...
- Reduced the number of Jimothy Core spawns to be closer to the spawn point of the ship on oxyde.
- SnailCat can go to orbit again.
- SnailCat can now warn for mimic crates.
- SnailCat enemy warning sound made louder and increased the interval for occurring.
